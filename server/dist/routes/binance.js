 ...
 */
async function fetchAllCandles(binanceSymbol, binanceInterval, startTime, endTime, headers) {
    const allCandles = [];
...
router.get('/candles', async (req, res) => {
    try {
        ...
        const data = await fetchAllCandles(binanceSymbol, binanceInterval, startTime, endTime, headers);
        if (data.length === 0) {
